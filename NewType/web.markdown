...
所属:
    ...
    IT 開発本部 民需・Web システム部 Web グループ

名前:

    村松 和麻 (kazuma@occ.co.jp)
...
* iDC本部 データセンター
* ITサービス本部 SDプロジェクト
    * 営業統括本部 新技術支援部 へ1年間レンタル
* ITサービス本部 内部情報システム部 内部情報グループ
* IT開発本部 民需・Web システム部 Web グループ <-- <span id="red">Now!</span>

Web グループのお仕事
--------------------

    グループウェア WebMagic の開発・保守等を行うグループ
